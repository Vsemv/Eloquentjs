...
// addEntry(['worked', 'touched tree', 'ate pizza', 'ran', 'watched TV'], false);
// addEntry(['worked', 'ate ice cream', 'ate cauliflower', 'ate lasagna', 'touched tree', 'brushed teeth'], false);
// addEntry(['day off', 'rode bike', 'rested', 'ate peanut', 'drank beer'], true);
...
console.log(tableFor('ate pizza', JOURNAL));
